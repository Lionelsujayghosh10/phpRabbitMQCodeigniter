              ...
              <form role="form" method="post" enctype="multipart/form-data">
                ...
                <?php } ?>
                    ...
                    <div class="form-group">
                      ...
                      <select name="student_id" class="form-control" id="student_selection">
                          <option value="">Select an class first</option>
                      </select>
                    </div>
                ...
                <div class="card-footer">
                  <input type="submit" class="btn btn-primary" target="_blank" name="create" value="Create" >
                </div>
              </form>
            </div>
            <!-- /.card -->
...
<script>
            ...
            success	: function(data){
                ...
                if(data !== "error" ){
                  ...
                  if(response.length > 0){
                    ...
                    $('#student_selection').html('<option value = "" >Select an section first</option>');
                  }else{
    ...
    $(document.body).on('change', '#section_selection', function(event){
          ...
          if(data !== "error" ){
            let response = JSON.parse(data);
              if(response.length > 0){
                ...
                for( i = 0; i < response.length; i++ ){
                  output +='<option value ="'+response[i].studentId+'" >'+response[i].student_name+'</option>';
                }
                $('#student_selection').html(output);
              } else {
